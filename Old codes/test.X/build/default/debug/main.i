...
# 2 "main.c" 2
# 18 "main.c"
unsigned char digits[] = {0x3e, 0x38, 0x3f, 0x6, 0x5b, 0x4f, 0x66, 0x6d, 0x7d, 0x7, 0x7f, 0x67};
# 36 "main.c"
...
void I2C_test(void)
{
    ...
    {
        I2C_send_data(0x40, 0x09, digits[i]);
...
void rightPosition(void)
{
    ...
    {
        PORTBbits.RB3 = 1;
        _delay((unsigned long)((1800)*(4000000/4000000.0)));
        PORTBbits.RB3 = 0;
        _delay((unsigned long)((19200)*(4000000/4000000.0)));
    }
}
...
void leftPosition(void)
{
    ...
    {
        PORTBbits.RB3 = 1;
        _delay((unsigned long)((2150)*(4000000/4000000.0)));
        PORTBbits.RB3 = 0;
        _delay((unsigned long)((19200)*(4000000/4000000.0)));
